...
const GROUPS: { title: string; screens: ScreenLink[] }[] = [
  ...
  },
  {
    ...
    screens: [
      ...
      { title: "Rides (Member Tab)", href: "/screens/member/rideshare", description: "Ride pool with mocked requests and My Rides state", icon: Car },
      { title: "Create Ride", href: "/screens/member/rideshare/create", description: "Create a new rideshare listing", icon: Plus },
      { title: "Listing Detail", href: "/screens/member/listing/1", description: "Full detail with join and external messaging handoff", icon: MapPin },
      ...
      { title: "Ride Detail", href: "/screens/member/rideshare/1", description: "Mocked ride request state with request-sent CTA", icon: Car },
